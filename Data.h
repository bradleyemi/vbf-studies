...
// Tue Oct 18 11:35:16 2016 by ROOT version 6.06/08
// from TTree Nominal/Nominal
// found on file: data_copy.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_copy.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_copy.root");
      }
